            ...
            <tbody>
                @foreach ($order->products as $product)
                    <tr>
                        ...
                        <td>{{ $currency }}{{ $product->discount_price ?? $product->price }}</td>
                        <td style="text-align: right">
                            {{ $currency }}{{ $product->pivot->quantity * ($product->discount_price ? $product->discount_price : $product->price) }}
                        </td>
                    </tr>
                @endforeach
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        {{ $currency }}{{ $order->delivery_charge }}</td>
                </tr>
                <tr>
                    <td colspan="3" style="text-align: right;border: 0;">
                        <strong>TOTAL</strong>
                ...
                @if ($order->discount)
                    <tr>
                        ...
                        <td style="text-align: right; color:red;">
                            -{{ $currency }}{{ round($order->discount, 2) }}
                        </td>
                    </tr>
                @endif
                <tr>
