                ...
                <tbody>
                    @foreach ($order->products as $product)
                        <tr>
                            <td style="padding-bottom: 0" colspan="2">
                                ...
                                {{ $product->pivot->quantity }} x {{ $currency }}{{ $product->price }}
                            </td>
                            <td style="text-align:right;vertical-align:bottom;padding-bottom: 0">
                                {{ $currency }}{{ $product->pivot->quantity * $product->price }}
                            </td>
                        </tr>
                    @endforeach
                    ...
                    @if ($order->discount)
                        <tr>
                            ...
                            <td style="text-align:right;vertical-align:bottom;padding-bottom: 0">
                                <strong>-{{ $currency }}{{ round($order->discount, 2) }}</strong>
                            </td>
                        </tr>
                    @endif
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;vertical-align:bottom;padding-bottom: 0">
                            <strong>{{ $currency }}{{ $order->amount >= $freeDelivery ? '0.00' : $deliveryCharge }}</strong>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;vertical-align:bottom;padding-bottom: 0">
                            <strong>{{ $currency }}{{ round($order->total_amount, 1) }}</strong>
                        </td>
                    </tr>
                </tbody>
            </table>
