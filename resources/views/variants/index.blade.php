                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="update{{ $variant->id }}">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h2 class="modal-title" id="exampleModalLabel">{{ __('Edit'). ' '. __('Variant') }}</h2>
                                                ...
                                                <form action="{{ route('variant.update', $variant->id) }}" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name_bn" class="form-control" value="{{ old('name_bn') ?? $variant->name_bn }}" placeholder="اسم المتغير">
                                                        </div>

                                                        <div class="mb-3">
                                                            <label>{{ __('Position') }}</label>
                                                            <input type="text" name="position" class="form-control" value="{{ old('position') ?? $variant->position }}" placeholder="{{ __('Position') }}">
                                                        </div>
                                                    </div>
                                        ...
                                        <a href="{{ route('variant.products', $variant->id) }}" class="btn btn-info">{{ __('Products') }}</a>
                                        @endcan
                                    </td>
                                    @endcanany
                                </tr>
