        ...
        <div style="margin-top: 40px">
            ...
            <div style="padding: 0 8px;border-bottom: 1px solid #57534E;font-size: 12px;">
                ...
                <div style=" margin: 8px 0;;display: table; width: 100%;">
                    ...
                    <span style="color: #1C1917;float: right;">{{ config('enums.currency')[0]. $order->amount }}</span>
                </div>
                <div style=" margin: 8px 0;;display: table; width: 100%;">
                    <span style="color: #57534E; float: left;">Pick-up and Delivery Charge</span>
                    <span style="color: #1C1917;float: right;">{{ config('enums.currency')[0].$delivery_charge }}</span>
                </div>
                <div style=" margin: 8px 0;;display: table; width: 100%;">
                    <span style="color: #57534E; float: left;">Discount</span>
                    <span style="color: #EF4444; float: right;">-{{ config('enums.currency')[0]. $order->discount }}</</span>
                </div>
            </div>

            <div style=" padding: 16px 8px; display: block;">
                <span style="color: #1C1917;float: left;font-size: 14px;">Paid Amount</span>
                <span style="color: #1C1917;float: right;font-size: 14px;">{{ config('enums.currency')[0]. $order->total_amount }}</span>
            </div>
