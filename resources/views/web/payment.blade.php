                            ...
                            <div class="card-body">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="mb-0 order">
                                            Sub total : <span> {{ $currency }}{{ $order->amount }}</span>
                                        </p>

                                        <p class="mb-0 order">
                                            Delivery Cost :
                                            <span>{{ $currency }}{{ $order->amount <= $freeDelivery ? $deliveryCharge : '00' }}</span>
                                        </p>

                                        <p class="mb-0 order">
                                            Discount : <span class="text-danger">
                                                -{{ $currency }}{{ $order->discount }}</span>
                                        </p>

                                        <p class="mb-0 order text-dark border-top py-2">
                                            Total Amount : <span> {{ $currency }}{{ $order->total_amount }}</span>
                                        </p>
