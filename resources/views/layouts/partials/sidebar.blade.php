<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid" style="min-height:0">
        ...
        <a class="navbar-brand " href="{{ route('root') }}">
            <img src="{{ $websetting->websiteLogoPath ?? asset('web/logo.png') }}" class="navbar-brand-img" alt="Admin Logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerGoldStar">
            ...
            <ul class="navbar-nav">
                ...
                @role('root')
                    ...
                    <li class="nav-item">
                        <a class="nav-link  {{ request()->routeIs('setting.*', 'deliveryCost', 'mobileApp', 'socialLink.*', 'webSetting.*', 'stripeKey.*') ? 'active' : '' }}"
                    ...
                    <div class="collapse {{ request()->routeIs('setting.*', 'deliveryCost', 'mobileApp', 'socialLink.*', 'profile.*', 'webSetting.*', 'stripeKey.*', 'schedule.*', 'invoiceManage.*', 'areas.*', 'sms-gateway.*') ? 'show' : '' }}"
                        id="setting">
                        <ul class="nav nav-sm flex-column">
                            @role('root')
                                ...
                                @endforeach
                                <a class="nav-link sub-menu {{ request()->routeIs('deliveryCost') ? 'active' : '' }}" href="{{ route('deliveryCost') }}">
                                ...
                                <a class="nav-link sub-menu {{ request()->routeIs('socialLink.*') ? 'active' : '' }}" href="{{ route('socialLink.index') }}">
                                ...
                                <a class="nav-link sub-menu {{ request()->routeIs('webSetting.*') ? 'active' : '' }}" href="{{ route('webSetting.index') }}">
